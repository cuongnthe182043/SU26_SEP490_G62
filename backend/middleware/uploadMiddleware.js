...
const uploadBill           = makeUploader(UPLOAD.FOLDERS.BILL);
...
module.exports = { uploadProof, uploadReceipt, uploadPaymentReceipt, uploadIncident, uploadAvatar, uploadExpense, uploadTripComplete, uploadBill };
