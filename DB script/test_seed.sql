...
-- ─── MIGRATION: thêm cột status vào debt_payments nếu chưa có ────────────────
...
BEGIN
    ...
    IF v_completed_shipment_id IS NOT NULL AND NOT EXISTS (
        ...
        INSERT INTO debt_payments (debt_id, amount, payment_method, status, created_by, notes, paid_at)
        SELECT d.id, 500000, 'cash', 'confirmed', v_driver_id, 'Nộp tiền mặt tại văn phòng', NOW() - INTERVAL '12 hours'
