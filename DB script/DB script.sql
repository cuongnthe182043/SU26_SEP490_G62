...
-- Ngày lễ hưởng nguyên lương; driver đi làm ngày lễ được cộng thêm 100% lương ngày (200% tổng)
...
-- Các thay đổi từ migration 2026-07 đã được gộp thẳng vào CREATE TABLE phía trên
-- (expenses: 5 loại + luồng duyệt; maintenance_records: requested/rejected;
--  vehicle_driver_assignments; financial_transactions: 15 event) — chỉ còn index:
